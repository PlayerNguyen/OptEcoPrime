...
/**
 * Command to add more balance into player account
 */
public class SubOptEcoAdd extends CommandSub {
    ...
    public SubOptEcoAdd(OptEcoPrime plugin, CommandInterface parent) {
        ...
        super(parent, COMMAND_NAME, Arrays.asList(
                ...
                CommandParameter.newParameter(
                        ...
                        true)),
                plugin.getLanguageConfiguration().getWithoutPrefix(LanguageConfigurationModel.COMMAND_ADD_DESCRIPTION)
                        .toString(),
                COMMAND_ALIASES);
    ...
    public CommandResult onExecute(CommandSender sender, List<String> params) {
        ...
        try {
            ...
            Teller.init(sender)
                    .next(plugin.getLanguageConfiguration()
                            .getWithPrefix(LanguageConfigurationModel.COMMAND_ADD_RESPONSE)
